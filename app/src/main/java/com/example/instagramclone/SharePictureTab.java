...
public class SharePictureTab extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgShare:
                ...
                // membuat perizinan untuk mengakses gambar dari storage
            ...
            case R.id.btnShareImage:
                if (receivedImageBitmap != null){
                    if (editDescription.getText().equals("")) {
                        FancyToast.makeText(getContext(), "Error : You must spesify a description",
                        ...
                        // untuk mengetahui objeck dari user mana
    ...
    // untuk mengetahui hasil perizinan user
    @Override
